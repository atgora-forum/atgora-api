  ...
  describe("dispatch routing", () => {
    ...
    it("dispatches reply create to reply indexer", async () => {
      const event: RecordEvent = {
        ...
        record: {
          content: "Reply",
          root: { uri: "at://did:plc:test/forum.atgora.topic.post/t1", cid: "bafyt" },
          parent: { uri: "at://did:plc:test/forum.atgora.topic.post/t1", cid: "bafyt" },
          community: "did:plc:community",
          createdAt: "2026-01-01T00:00:00.000Z",
        },
        cid: "bafyreply",
    ...
    it("dispatches reaction create to reaction indexer", async () => {
      const event: RecordEvent = {
        ...
        rkey: "react1",
        record: {
          subject: { uri: "at://did:plc:test/forum.atgora.topic.post/t1", cid: "bafyt" },
          type: "like",
          community: "did:plc:community",
          createdAt: "2026-01-01T00:00:00.000Z",
        },
